...
Thank you for your interest in contributing to Vox! This document provides guidelines and instructions for contributing.
...
This builds the CPU sidecar (bundled with the app), the CUDA binary (placed in `%APPDATA%/sh.vox.app/backends/` for runtime GPU switching), and the installable Tauri app.
...
Thank you for contributing to Vox! 🎉
