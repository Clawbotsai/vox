"""POST /speak — REST wrapper around vox.speak for non-MCP callers.
...
bindings (via X-Vox-Client-Id) work identically.
"""
...
async def speak(
    ...
    """Speak text in a voice profile. Mirrors vox.speak (MCP).
    ...
    if profile is None:
        ...
        raise HTTPException(
            ...
            detail=(
                ...
                "or configure a default in Vox → Settings → MCP."
            ),
        )
