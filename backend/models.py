...
class MCPClientBindingResponse(BaseModel):
    ...
    use when a given client_id calls vox.speak without args, plus an
...
class SpeakRequest(BaseModel):
    """Body for POST /speak — non-MCP REST surface that mirrors vox.speak."""
...
class CloudStatusResponse(BaseModel):
    """Current link between this device and a Vox Cloud account."""
