...
//! Vox itself" and short-circuit the synthetic-paste path. On
//! Windows, `bundle_id` holds the lowercased exe basename (`"vox.exe"`)
...
mod win {
    ...
    /// (e.g. `"vox.exe"`). This is the Windows analogue of macOS'
