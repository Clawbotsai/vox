    ...
    <>
      ...
      <div className="max-w-md mx-auto h-full flex items-center">
        <div className="flex flex-col items-center text-center space-y-5">
          <FadeIn delay={0}>
            <img src={voxLogo} alt="Vox" className="w-20 h-20 object-contain" />
          </FadeIn>

          <FadeIn delay={80}>
            <div className="space-y-1.5">
              <h1 className="text-lg font-semibold">Vox</h1>
          ...
          <FadeIn delay={320}>
            <div className="flex flex-wrap justify-center gap-3 pt-2">
              ...
              <a
                href="https://github.com/Clawbotsai/vox"
                target="_blank"
                rel="noopener noreferrer"
                className="group inline-flex items-center gap-2 rounded-lg border border-border/60 px-4 py-2 text-sm transition-colors hover:bg-muted/50"
              >
              ...
              <Trans
                ...
                components={{
                  link: (
                    ...
                    <a
                      href="https://github.com/Clawbotsai/vox/blob/main/LICENSE"
                      target="_blank"
                      rel="noopener noreferrer"
