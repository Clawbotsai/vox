...
const DEMO_SCRIPT: DemoStep[] = [
  ...
  {
    profileIndex: 5,
    text: "So we got this voice cloning software and honestly it's kind of terrifying. Like, my wife could not tell the difference. Vox dot s h, link in the description!",
  ...
  {
    profileIndex: 6,
    text: 'This is Vox in one hundred seconds. It clones voices locally, it runs on your GPU, and no, OpenAI cannot hear you. Lets go.',
          ...
          <div className="flex-1 flex flex-col md:flex-row min-w-0 relative">
            ...
            <div className="flex flex-col min-w-0 relative md:flex-1 md:overflow-hidden">
              ...
              <div className="absolute top-0 left-0 right-0 z-10 px-4 pt-4 md:pt-6 pb-2 flex items-center justify-between">
                <h2 className="text-base font-bold">Vox</h2>
