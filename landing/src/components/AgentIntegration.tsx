...
const SCENARIOS: Scenario[] = [
  {
    ...
    log: [
      ...
      { prefix: '→', text: 'vox.speak({ profile: "Morgan" })', tone: 'dim' },
    ],
  ...
  },
  {
    ...
    log: [
      ...
      { prefix: '→', text: 'vox.speak({ profile: "Scarlett" })', tone: 'dim' },
    ],
  ...
  },
  {
    ...
    log: [
      ...
      { prefix: '→', text: 'vox.speak({ profile: "Jarvis" })', tone: 'dim' },
    ],
      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="max-w-3xl mx-auto text-center mb-14">
          ...
          <p className="text-muted-foreground text-base md:text-lg leading-relaxed">
            One tool call —{' '}
            <code className="text-accent font-mono text-[0.9em]">vox.speak</code> —
