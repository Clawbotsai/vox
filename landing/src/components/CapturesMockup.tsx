...
const CAPTURES: Capture[] = [
  ...
  },
  {
    ...
    seed: 53,
    transcriptRaw:
      "okay the real magic is this you speak to vox your transcript gets cleaned up by a local LLM it pastes into whatever you're focused on then the agent you're talking to responds and it replies with voice in a voice you cloned through the same pill that's the loop elevenlabs has TTS wisprflow has dictation but neither runs locally and neither does both halves vox is full voice IO for humans and AI agents entirely on your machine",
    transcriptRefined:
      "Okay, the real magic: you speak to Vox, your transcript gets cleaned up by a local LLM, and it pastes into whatever you're focused on. Then the agent you're talking to responds — and it replies with voice, in a voice you've cloned, through the same pill. That's the loop. ElevenLabs has TTS, WisprFlow has dictation, but neither runs locally and neither does both halves. Vox is full voice I/O for humans and AI agents, entirely on your machine.",
    durationMs: 42000,
    ago: 'Yesterday',
