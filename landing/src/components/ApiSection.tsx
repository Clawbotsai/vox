...
const USE_CASES = [
	...
	},
	{
		...
		title: "Scripts & tools",
		description:
			"Batch-generate audiobook chapters, automate podcast intros, or wire Vox into your Stream Deck. It's just a localhost URL.",
	},
];
					...
					<div className="lg:col-span-3 rounded-xl border border-border bg-card/60 backdrop-blur-sm overflow-hidden">
						...
						<div className="border-t border-border/60 px-5 py-3 bg-card/40">
							...
							>
								...
								<code className="font-mono">/docs</code> when Vox is running
								→
							</a>
						</div>
					</div>
