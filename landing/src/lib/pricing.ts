...
export const CLOUD_NOTIFY_URL = "https://x.com/VoxAI";
...
export const PRICING_TIERS: PricingTier[] = [
	{
		...
		badge: "Available now",
		cta: {label: "Download Vox", href: "/download"},
		features: [
	...
	},
	{
		...
		priceNote: "Launch price · free for $VOX holders",
		highlighted: true,
		badge: "Coming soon",
...
export const CLOUD_FEATURES: CloudFeature[] = [
	...
	},
	{
		...
		body: "Voice profiles, generations, and captures — including the original audio Vox keeps alongside each transcript — safe off your machine.",
	},
	{
	...
	},
	{
		...
		body: "Vox works fully offline without an account. Cloud is an add-on for when you want backup and sync — never a requirement.",
	},
];
