        ...
        <div className="mx-auto flex max-w-5xl items-center justify-between px-6 py-4">
          <Link href="/" className="flex items-center gap-2.5">
            <Image
              ...
              className="h-7 w-7"
            />
            <span className="text-[15px] font-semibold text-foreground">Vox</span>
          </Link>
          <Link
            href="/"
            ...
            {triggered ? (
              <>
                ...
                <p className="text-lg text-muted-foreground">
                  {activeMeta
                    ? `Downloading Vox for ${activeMeta.label} (${activeMeta.description}). Check your downloads folder.`
                    : 'Check your downloads folder for Vox.'}
                </p>
              </>
            ) : (
              <>
                <h1 className="text-4xl md:text-5xl font-semibold tracking-tight text-foreground mb-4">
                  {linksError ? "We couldn't load the latest release." : 'Download Vox'}
                </h1>
                <p className="text-lg text-muted-foreground">
                  {linksError
        ...
        <div className="mt-16 rounded-2xl border border-border bg-gradient-to-br from-card via-card/80 to-background backdrop-blur-sm p-8 md:p-10 overflow-hidden relative">
          ...
          <div className="relative">
            ...
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight text-foreground mb-4">
              Jamie here — Vox is a side project.
            </h2>
            <p className="text-muted-foreground leading-relaxed mb-6 max-w-2xl">
              I build and maintain Vox in my spare time. It's completely
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                Get familiar with Vox — setup, voice cloning, the REST API.
              </p>
            </a>
            <a
              href="https://deepwiki.com/Clawbotsai/vox"
              target="_blank"
              rel="noopener noreferrer"
              className="rounded-xl border border-border bg-card/60 backdrop-blur-sm p-5 hover:border-accent/30 hover:bg-card transition-all group"
            >
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                DeepWiki is an AI that knows Vox inside-out. Ask anything.
              </p>
            </a>
            <a
              href={GITHUB_REPO}
