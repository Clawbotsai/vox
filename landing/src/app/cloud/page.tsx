...
export const metadata: Metadata = {
	title: "Cloud Backup & Sync — Vox",
	description:
		"End-to-end encrypted backup and sync for your Vox library. We can't read your data — only your devices can. Optional, local-first, free for $VOX holders.",
	openGraph: {
		title: "Vox Cloud — encrypted backup & sync",
		description:
			"End-to-end encrypted backup and sync across desktop and mobile. The server is blind — only your devices can decrypt.",
		type: "website",
		url: "https://vox.sh/cloud",
			...
			<section className="relative pt-32 pb-16">
				...
				<div className="relative mx-auto max-w-4xl px-6 text-center">
					...
					<p className="fade-in mx-auto mt-6 max-w-2xl text-lg text-muted-foreground md:text-xl">
						...
						Vox library. We can't read a byte of it — only your devices
						can. Free for{" "}
				...
				<div className="mx-auto max-w-3xl px-6">
					<div className="rounded-2xl border-2 border-accent/40 bg-card/60 backdrop-blur-sm p-8 md:p-10 text-center shadow-[0_8px_40px_hsl(43_60%_50%/0.08)]">
						...
						<p className="text-muted-foreground leading-relaxed max-w-2xl mx-auto">
							Vox is local-first and privacy-first. The cloud keeps that
