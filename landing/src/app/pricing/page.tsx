...
export const metadata: Metadata = {
	title: "Pricing — Vox",
	description:
		"Vox is free and open source forever. Optional, end-to-end encrypted cloud backup & sync — free for $VOX holders.",
	openGraph: {
		title: "Vox Pricing",
		description:
			"The app is free forever. Cloud backup & sync is an optional add-on — free for $VOX holders.",
		type: "website",
		url: "https://vox.sh/pricing",
...
const FAQ = [
	{
		...
		a: "Yes — Vox is free and open source, forever. Cloning, dictation, every TTS engine, MCP, personalities: all of it runs locally with no account. The paid plans only add optional cloud backup & sync.",
	},
	{
	...
	{
		q: "Do $VOX holders really get Cloud free?",
			...
			<section className="relative pt-32 pb-12">
				...
				<div className="relative mx-auto max-w-4xl px-6 text-center">
					...
					<p className="fade-in mx-auto mt-6 max-w-2xl text-lg text-muted-foreground">
						Everything that makes Vox great runs locally at no cost. Pay
