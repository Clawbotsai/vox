...
export const metadata: Metadata = {
	title: `${TOKEN_TICKER} — The official Vox token`,
	description: `${TOKEN_TICKER} is the official community token for Vox on Solana. Entirely optional — Vox is, and always will be, free and open source.`,
	openGraph: {
		title: `${TOKEN_TICKER} on Solana`,
		description: `The official community token for Vox. Optional, just for fun — Vox stays free and open source.`,
		type: "website",
		url: "https://vox.sh/token",
...
const USE_OF_FUNDS = [
	{
		...
		body: "The token is the equivalent of a salary — it lets me work on Vox every day instead of squeezing it around other work.",
	},
	{
		icon: Cloud,
	...
	},
	{
		...
		body: "Adding TTS engines and broadening GPU / OS support so Vox runs great on whatever you've got.",
	},
];

const FAQ = [
	{
		q: "Do I need the token to use Vox?",
		a: "No. Vox is free and open source, and every feature works without ever touching the token. It exists purely for supporters who want to back the project and have some fun.",
	},
	{
		q: "Is this an investment?",
		a: "No. $VOX is a community token, not a security or a promise of returns. There is no roadmap of financial milestones, and nothing here is financial advice. Only spend what you're comfortable with.",
	},
	{
		q: "How do I buy it?",
	...
	},
	{
		...
		a: "Yes — going full-time on Vox is funded by the token, alongside donations. The surest way to support the project either way is to use it, star the repo, and tell people about it.",
	},
];
					...
					<div className="mx-auto max-w-3xl px-6">
						<div className="text-center mb-12">
							...
							<p className="text-muted-foreground max-w-2xl mx-auto mt-4">
								Vox grew to over a million downloads with zero marketing —
					...
					<div className="mx-auto max-w-3xl px-6">
						<div className="rounded-2xl border border-border bg-card/40 backdrop-blur-sm p-8">
							...
							<ul className="space-y-3">
								<ProofRow text={`${TOKEN_TICKER} is the only official Vox token. The mint address on this page is the single source of truth — always verify it.`} />
