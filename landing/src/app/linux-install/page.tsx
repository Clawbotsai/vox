...
export const metadata: Metadata = {
  title: 'Linux Install - Vox',
  description: 'Build Vox from source on Linux. Clone, setup, and build in three commands.',
};
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="rounded-lg border border-border bg-card/60 p-4 font-mono text-sm">
                  ...
                  <div>git clone https://github.com/Clawbotsai/vox.git</div>
                  <div>cd vox</div>
                </div>
